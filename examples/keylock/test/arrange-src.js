...
(function () {
  ...
  /**
   * Cascaded one-pole low-pass. One stage rolls off at only 6dB/octave, which
   * leaks so much low-mid that a loud pad reads as bass and a breakdown with
   * energy in it goes undetected. Three stages give 18dB/octave — enough to
   * separate a kick's fundamental from everything above it.
   */
